...
static const char AMLinearViewControllerMargin_lcBottomMargin = '\0';

- (void)setLcBottomMargin:(CGFloat)lcMargin {
    objc_setAssociatedObject(self, &AMLinearViewControllerMargin_lcBottomMargin, @(lcMargin), OBJC_ASSOCIATION_COPY);
}

- (CGFloat)lcBottomMargin {
    NSNumber *bottomMargin = objc_getAssociatedObject(self, &AMLinearViewControllerMargin_lcBottomMargin);
    if (bottomMargin) {
...
static const char AMLinearViewControllerMargin_lcTopMargin = '\0';

- (void)setLcTopMargin:(CGFloat)lcMargin {
    objc_setAssociatedObject(self, &AMLinearViewControllerMargin_lcTopMargin, @(lcMargin), OBJC_ASSOCIATION_COPY);
}

- (CGFloat)lcTopMargin {
    NSNumber *margin = objc_getAssociatedObject(self, &AMLinearViewControllerMargin_lcTopMargin);
    if (margin) {
...
static const char AMLinearViewControllerMargin_lcLeftMargin = '\0';

- (void)setLcLeftMargin:(CGFloat)lcMargin {
    objc_setAssociatedObject(self, &AMLinearViewControllerMargin_lcLeftMargin, @(lcMargin), OBJC_ASSOCIATION_COPY);
}

- (CGFloat)lcLeftMargin {
    NSNumber *margin = objc_getAssociatedObject(self, &AMLinearViewControllerMargin_lcLeftMargin);
    if (margin) {
        return [margin floatValue];
    } else {
        return -1;
...
static const char AMLinearViewControllerMargin_lcRightMargin = '\0';

- (void)setLcRightMargin:(CGFloat)lcMargin {
    objc_setAssociatedObject(self, &AMLinearViewControllerMargin_lcRightMargin, @(lcMargin), OBJC_ASSOCIATION_COPY);
}

- (CGFloat)lcRightMargin {
    NSNumber *margin = objc_getAssociatedObject(self, &AMLinearViewControllerMargin_lcRightMargin);
    if (margin) {
        return [margin floatValue];
    } else {
        return -1;
...
@implementation UIView (AMLinearViewControllerSize)

static const char AMLinearViewControllerSize_lcHeight = '\0';

- (void)setLcHeight:(CGFloat)lcHeight {
    objc_setAssociatedObject(self, &AMLinearViewControllerSize_lcHeight, @(lcHeight), OBJC_ASSOCIATION_COPY);
}

- (CGFloat)lcHeight {
    NSNumber *height = objc_getAssociatedObject(self, &AMLinearViewControllerSize_lcHeight);
    if (height) {
...
static const char AMLinearViewControllerSize_lcRightWidth = '\0';

- (void)setLcWidth:(CGFloat)lcWidth {
    objc_setAssociatedObject(self, &AMLinearViewControllerSize_lcRightWidth, @(lcWidth), OBJC_ASSOCIATION_COPY);
}

- (CGFloat)lcWidth {
    NSNumber *width = objc_getAssociatedObject(self, &AMLinearViewControllerSize_lcRightWidth);
    if (width) {
...
@interface AMLinearViewController ()
...
@implementation AMLinearViewController
...
- (void)setupViewLayout {
    ...
    for (NSUInteger i = 0; i < self.childViewList.count; i++) {
        ...
        switch (self.gravity) {
            case AMLinearViewControllerGravityStart: {
                ...
                break;
            case AMLinearViewControllerGravityEnd: {
                [self.container addConstraint:[NSLayoutConstraint constraintWithItem:childView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.container attribute:NSLayoutAttributeRight multiplier:1 constant:-rightMargin]];
                if (childView.lcWidth >= 0) {
                    // 宽度约束
                    [childView addConstraint:[NSLayoutConstraint constraintWithItem:childView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:childView.lcWidth]];
                ...
                break;
            case AMLinearViewControllerGravityCenter: {
                if (childView.lcWidth >= 0) {
                    // 宽度约束
                    [childView addConstraint:[NSLayoutConstraint constraintWithItem:childView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:childView.lcWidth]];
                ...
                break;
            case AMLinearViewControllerGravityFit: {
                [self.container addConstraint:[NSLayoutConstraint constraintWithItem:childView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.container attribute:NSLayoutAttributeLeft multiplier:1 constant:leftMargin]];
                [self.container addConstraint:[NSLayoutConstraint constraintWithItem:childView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.container attribute:NSLayoutAttributeRight multiplier:1 constant:-rightMargin]];
            }
                break;
